    ...
    describe('signup', () => {
       ...
       */
        it('should register a new user and send verification email', async () => {
            ...
            db.role.findOne = jest.fn().mockResolvedValue(mockUser);
            db.user_roles.create = jest.fn().mockResolvedValue({});
            jwt.sign.mockReturnValue('mocktoken');
    ...
    describe('logout', () => {
      ...
      */
        it('should log out successfully', async () => {
            ...
            db.session.updateOne = jest.fn().mockResolvedValue([1]);
        ...
        it('should return 500 on server error during logout', async () => {
            req.user = { id: 1 };
            req.headers.authorization = 'Bearer mocktoken';
            db.session.updateOne = jest.fn().mockRejectedValue(new Error('Server error'));
