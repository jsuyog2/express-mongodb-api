...
describe('User Controller', () => {
    ...
    describe('GET /user', () => {
        ...
        it('should retrieve user details successfully', async () => {
            db.user.findById = jest.fn().mockResolvedValue(userMock);
        ...
        it('should return 404 if user not found', async () => {
            db.user.findById = jest.fn().mockResolvedValue(null);
        ...
        it('should handle server errors', async () => {
            db.user.findById = jest.fn().mockRejectedValue(new Error('Database error'));
